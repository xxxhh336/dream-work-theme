"use strict";var pe=Object.defineProperty;var he=(e,n,t)=>n in e?pe(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var k=(e,n,t)=>he(e,typeof n!="symbol"?n+"":n,t);const w=require("electron"),ge=require("path"),fe=require("fs"),j=require("child_process"),N=require("util"),be=require("os"),we=require("http"),xe=require("net"),ye=require("fs/promises"),ke=require("crypto");function I(e){const n=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(e){for(const t in e)if(t!=="default"){const o=Object.getOwnPropertyDescriptor(e,t);Object.defineProperty(n,t,o.get?o:{enumerable:!0,get:()=>e[t]})}}return n.default=e,Object.freeze(n)}const l=I(ge),d=I(fe),C=I(be),ve=I(we),ee=I(xe),te=I(ke),S=process.env.LOCALAPPDATA||l.join(C.homedir(),"AppData","Local"),z=process.env.APPDATA||l.join(C.homedir(),"AppData","Roaming"),T=process.env.ProgramFiles||"C:\\Program Files",J=process.env["ProgramFiles(x86)"]||"C:\\Program Files (x86)",ne=[{id:"workbuddy",name:"WorkBuddy",exeNames:["WorkBuddy.exe"],processName:"WorkBuddy.exe",defaultPort:9339,installPaths:[l.join(S,"workbuddy"),l.join(S,"Programs","workbuddy"),l.join(T,"WorkBuddy"),l.join(J,"WorkBuddy"),"D:\\Program Files\\WorkBuddy"],rendererHints:["app.asar/renderer/index.html","renderer/index.html","index.html"],kind:"workbuddy"},{id:"codex",name:"Codex",exeNames:["ChatGPT.exe","Codex.exe"],processName:"ChatGPT.exe",defaultPort:9340,installPaths:[l.join(S,"Programs","Codex"),l.join(S,"Programs","OpenAI","Codex"),l.join(T,"Codex"),l.join(J,"Codex"),"D:\\Program Files\\Codex"],rendererHints:["index.html","renderer/index.html"],kind:"codex"},{id:"trae-work",name:"TRAE Work",exeNames:["TRAE SOLO CN.exe","TRAE Work CN.exe"],processName:"TRAE SOLO CN.exe",defaultPort:9341,installPaths:["D:\\Program Files\\TRAE SOLO CN",l.join(S,"Programs","TRAE SOLO CN"),l.join(T,"TRAE SOLO CN")],rendererHints:["solo/solo-lite.html","solo-lite.html"],kind:"vscode-work"},{id:"qoder-work",name:"QoderWork",exeNames:["QoderWork CN.exe","QoderWork.exe"],processName:"QoderWork CN.exe",defaultPort:9342,installPaths:["D:\\Program Files\\QoderWork CN",l.join(S,"Programs","QoderWork CN"),l.join(T,"QoderWork CN")],rendererHints:["out/renderer/index.html","renderer/index.html"],kind:"generic-work",devToolsActivePort:l.join(z,"QoderWork CN","DevToolsActivePort")},{id:"catpaw",name:"CatPaw",exeNames:["CatPaw.exe"],processName:"CatPaw.exe",defaultPort:9343,installPaths:[l.join(S,"CatPaw"),l.join(S,"Programs","CatPaw"),l.join(T,"CatPaw")],rendererHints:["app.asar/dist/index.html","dist/index.html"],kind:"generic-work"},{id:"zcode",name:"ZCode",exeNames:["ZCode.exe"],processName:"ZCode.exe",defaultPort:9344,installPaths:["D:\\Program Files\\ZCode",l.join(S,"Programs","ZCode"),l.join(T,"ZCode")],rendererHints:["out/renderer/index.html","renderer/index.html"],kind:"generic-work"},{id:"qwen-office",name:"千问办公",exeNames:["QwenWorkCN.exe"],processName:"QwenWorkCN.exe",defaultPort:9345,installPaths:["D:\\Program Files\\QwenWorkCN",l.join(S,"Programs","QwenWorkCN"),l.join(T,"QwenWorkCN")],rendererHints:["out/renderer/index.html","renderer/index.html"],kind:"generic-work",devToolsActivePort:l.join(z,"QwenWorkCN","DevToolsActivePort")}];function $(e){return ne.find(n=>n.id===e)}N.promisify(j.exec);const Ce=N.promisify(j.execFile);function Se(){const e=[],n=l.join(process.env.ProgramFiles||"C:\\Program Files","WindowsApps");if(!d.existsSync(n))return e;try{const t=d.readdirSync(n);for(const o of t)if(/^OpenAI\.Codex_\d+/i.test(o)){const r=l.join(n,o,"app","ChatGPT.exe");d.existsSync(r)&&e.push(r)}}catch{}return e}async function $e(){const e=`
...
`;try{const{stdout:n}=await Ce("powershell.exe",["-NoLogo","-NoProfile","-NonInteractive","-ExecutionPolicy","Bypass","-Command",e],{encoding:"utf8",maxBuffer:4194304}),t=n.trim();if(t&&d.existsSync(t))return t}catch{}return null}async function Te(){const e=[];for(const o of ne.filter(r=>r.id!=="codex")){const r=K(o.exeNames,o.installPaths);r&&e.push({appId:o.id,name:o.name,path:r})}const n=K(["Codex.exe","ChatGPT.exe"],[l.join(process.env.LOCALAPPDATA||"","Programs","Codex"),l.join(process.env.LOCALAPPDATA||"","Programs","OpenAI","Codex"),...Se()]),t=n?null:await $e();return t?e.push({appId:"codex",name:"Codex",path:t}):n&&e.push({appId:"codex",name:"Codex",path:n}),e}function K(e,n){for(const t of n){if(!t||!d.existsSync(t))continue;if(d.statSync(t).isFile()&&e.some(r=>l.basename(t).toLowerCase()===r.toLowerCase()))return t;for(const r of e){const a=l.join(t,r);if(d.existsSync(a))return a}try{const r=d.readdirSync(t,{withFileTypes:!0}).filter(a=>a.isDirectory()).sort((a,s)=>s.name.localeCompare(a.name,void 0,{numeric:!0}));for(const a of r)for(const s of e){const c=l.join(t,a.name,s);if(d.existsSync(c))return c}}catch{}}return null}const V=N.promisify(j.execFile);async function Ee(e){const n=$(e);if(!n)return!1;const t=[...new Set([n.processName,...n.exeNames].filter(Boolean))];if(C.platform()==="win32"){for(const o of t)try{const{stdout:r}=await V("tasklist.exe",["/FI",`IMAGENAME eq ${o}`,"/FO","CSV","/NH"],{encoding:"utf8",windowsHide:!0});if(r.split(/\r?\n/).some(a=>a.trim().toLowerCase().startsWith(`"${o.toLowerCase()}"`)))return!0}catch{}return!1}for(const o of t)try{return await V("pgrep",["-f",o],{encoding:"utf8"}),!0}catch{}return!1}async function oe(e,n){const t=$(e);if(!t)return{success:!1,error:`Unknown app: ${e}`};const o=t.defaultPort,r=[`--remote-debugging-port=${o}`];e==="codex"&&r.push("--disable-extensions"),n&&r.push(`--dream-theme=${n}`);try{const a=Le(e);if(console.log(`[launcher] Killing existing ${e} instances...`),await De(e),await _e(o,15e3),t.devToolsActivePort)try{d.unlinkSync(t.devToolsActivePort)}catch{}console.log(`[launcher] Launching ${a} with args: ${r.join(" ")}`);const s=j.spawn(a,r,{detached:!0,stdio:"ignore",env:Pe()});s.unref(),console.log(`[launcher] Spawned process with PID: ${s.pid}`),console.log(`[launcher] Waiting for CDP port ${o} to be ready...`);let c=o;return t.devToolsActivePort?c=await Ie(t.devToolsActivePort,t.rendererHints,3e4):await je(o,3e4),console.log(`[launcher] CDP port ${c} is ready`),{success:!0,port:c}}catch(a){return console.error("[launcher] Launch failed:",a),{success:!1,error:a.message}}}function Pe(){const e={...process.env};for(const n of["VITE_DEV_SERVER_URL","ELECTRON_RENDERER_URL","MAIN_VITE_DEV_SERVER_URL","ELECTRON_RUN_AS_NODE"])delete e[n];return e}async function Ie(e,n,t){const o=Date.now();let r=0;for(;Date.now()-o<t;){try{const a=d.readFileSync(e,"utf8").split(/\r?\n/,1)[0],s=Number(a);if(Number.isInteger(s)&&s>0)return r=s,await Me(s,n,3e3),s}catch{}await new Promise(a=>setTimeout(a,500))}throw new Error(`DevToolsActivePort did not expose a live renderer${r?` on port ${r}`:""}: ${e}`)}async function Me(e,n,t){const o=Date.now();for(;Date.now()-o<t;){try{const r=await fetch(`http://127.0.0.1:${e}/json/list`,{signal:AbortSignal.timeout(1e3)});if(r.ok){const a=await r.json();if(Array.isArray(a)&&a.some(s=>(s==null?void 0:s.type)==="page"&&n.some(c=>String(s.url).includes(c))))return}}catch{}await new Promise(r=>setTimeout(r,250))}throw new Error(`CDP renderer endpoint is not ready on port ${e}`)}async function je(e,n){const t=Date.now();let o="unknown";for(;Date.now()-t<n;)try{await new Promise((r,a)=>{const s=ee.createConnection(e,"127.0.0.1",()=>{s.end(),r()});s.once("error",c=>{o=c.message,a(c)}),setTimeout(()=>{s.destroy(),a(new Error("timeout"))},1e3)}),console.log(`[launcher] Port ${e} is open, verifying CDP endpoint...`),await Ae(e,15e3),console.log(`[launcher] CDP endpoint verified on port ${e}`);return}catch(r){o=r.message,console.log(`[launcher] Port check failed: ${r.message}, retrying...`),await new Promise(a=>setTimeout(a,1e3))}throw new Error(`CDP port ${e} did not become ready within ${n}ms (last error: ${o})`)}async function Ae(e,n){const t=Date.now();for(;Date.now()-t<n;)try{await new Promise((o,r)=>{const a=ve.request({hostname:"127.0.0.1",port:e,path:"/json/version",method:"GET",timeout:2e3},s=>{let c="";s.on("data",i=>{c+=i}),s.on("end",()=>{s.statusCode===200?(console.log(`[launcher] CDP version response: ${c.substring(0,200)}`),o()):r(new Error(`HTTP ${s.statusCode}`))})});a.on("error",r),a.on("timeout",()=>{a.destroy(),r(new Error("timeout"))}),a.end()});return}catch(o){if(Date.now()-t>=n)throw o;await new Promise(r=>setTimeout(r,1e3))}}async function De(e){const n=C.platform(),t=$(e);if(!t)return;const o=[...new Set([t.processName,...t.exeNames].filter(Boolean))];try{if(n==="win32"){const{execSync:r}=require("child_process");for(const a of o)try{r(`taskkill /T /F /IM "${a}" 2>nul`,{stdio:"ignore"}),console.log(`[launcher] Killed existing ${a} process tree`)}catch{}}else if(n==="darwin"){const{execSync:r}=require("child_process");for(const a of o)try{r(`pkill -f "${a}" 2>/dev/null || true`,{stdio:"ignore"}),console.log(`[launcher] Killed existing ${a} processes`)}catch{}}else if(n==="linux"){const{execSync:r}=require("child_process");for(const a of o)try{r(`pkill -f "${a}" 2>/dev/null || true`,{stdio:"ignore"}),console.log(`[launcher] Killed existing ${a} processes`)}catch{}}}catch(r){console.warn("[launcher] Failed to kill existing instances:",r)}}async function _e(e,n){const t=Date.now();for(;Date.now()-t<n;){if(!await new Promise(r=>{const a=ee.createConnection(e,"127.0.0.1");a.once("connect",()=>{a.destroy(),r(!0)}),a.once("error",()=>r(!1)),a.setTimeout(500,()=>{a.destroy(),r(!1)})})){console.log(`[launcher] Previous CDP port ${e} is closed`);return}await new Promise(r=>setTimeout(r,250))}throw new Error(`Existing ${e} CDP service did not stop; refusing to inject into the old application instance`)}function Le(e){const n=$(e);if(!n)throw new Error(`Unknown app: ${e}`);const t=C.platform();if(t==="win32"){for(const a of n.installPaths){if(!a||!d.existsSync(a))continue;if(d.statSync(a).isFile())return a;for(const c of n.exeNames){const i=l.join(a,c);if(d.existsSync(i))return i}const s=d.readdirSync(a,{withFileTypes:!0}).filter(c=>c.isDirectory()).sort((c,i)=>i.name.localeCompare(c.name,void 0,{numeric:!0}));for(const c of s)for(const i of n.exeNames){const m=l.join(a,c.name,i);if(d.existsSync(m))return m}}const o=n.exeNames,r=[process.env.ProgramFiles,process.env["ProgramFiles(x86)"]].filter(Boolean);for(const a of r){if(!a||!d.existsSync(a))continue;const c=d.readdirSync(a).find(i=>i.toLowerCase().includes(e.replace("-",""))||i.toLowerCase().includes(n.name.toLowerCase()));if(c){const i=l.join(a,c);for(const m of o){const h=l.join(i,m);if(d.existsSync(h))return h}}}if(e==="codex"){const a=l.join(process.env.ProgramFiles||"C:\\Program Files","WindowsApps");console.log("[launcher] Codex WindowsApps fallback, path:",a);try{const c=d.readdirSync(a).find(i=>/^OpenAI\.Codex_\d+/i.test(i));if(c){const i=l.join(a,c,"app","ChatGPT.exe");if(d.existsSync(i))return console.log("[launcher] Found Codex via WindowsApps scan:",i),i}}catch(s){console.log("[launcher] WindowsApps scan error:",s.message)}try{const{execFileSync:s}=require("child_process"),c="Get-AppxPackage -Name 'OpenAI.Codex' -ErrorAction SilentlyContinue | ForEach-Object { Join-Path $_.InstallLocation (Get-AppxPackageManifest -Package $_.PackageFullName).Package.Applications.Application.Executable }";console.log("[launcher] Running PowerShell fallback...");const i=s("powershell.exe",["-NoLogo","-NoProfile","-NonInteractive","-ExecutionPolicy","Bypass","-Command",c],{encoding:"utf8",stdio:["pipe","pipe","ignore"]}).trim();if(console.log("[launcher] PowerShell result:",i),i&&d.existsSync(i))return i}catch(s){console.log("[launcher] PowerShell fallback error:",s.message)}}}else if(t==="darwin"){const o=["/Applications/WorkBuddy.app","/Applications/ChatGPT.app"];for(const r of o)if(d.existsSync(r))return r}else if(t==="linux"){const o=e==="workbuddy"?["workbuddy","WorkBuddy"]:["codex","Codex"],r=["/usr/bin","/usr/local/bin","/opt",l.join(C.homedir(),".local","bin"),"/snap/bin"];for(const a of r)if(d.existsSync(a))for(const s of o){const c=l.join(a,s);if(d.existsSync(c))return c}for(const a of o)try{const{execSync:s}=require("child_process"),c=s(`which ${a} 2>/dev/null || echo ''`).toString().trim();if(c&&d.existsSync(c))return c}catch{}}throw new Error(`Could not find ${e} executable`)}const Ne=5e3,Oe=100,Be=15e3,Ue=1e4,We=5e3;function Re(e){if(!Number.isInteger(e)||e<1024||e>65535)throw new TypeError("port must be an integer from 1024 through 65535");return e}function P(e,n,t={}){const o=t.allowZero?0:Number.EPSILON;if(!Number.isFinite(e)||e<o){const r=t.allowZero?"non-negative":"positive";throw new TypeError(`${n} must be a finite ${r} number`)}return e}function re(e){if(typeof e!="string"||e.length===0||e!==e.trim())throw new TypeError("webSocketDebuggerUrl must be a non-empty URL string");let n;try{n=new URL(e)}catch(t){throw new TypeError(`webSocketDebuggerUrl is invalid: ${t.message}`)}if(n.protocol!=="ws:"||n.hostname!=="127.0.0.1"||n.username||n.password||n.hash||!n.port)throw new TypeError("webSocketDebuggerUrl must use ws://127.0.0.1 with an explicit port");return Re(Number(n.port)),n}function Fe(e,n){if(e===null||typeof e!="object"||Array.isArray(e)||e.type!=="page"||typeof e.url!="string"||typeof e.webSocketDebuggerUrl!="string")return!1;try{re(e.webSocketDebuggerUrl)}catch{return!1}return e.url.includes(n)}function F(e){if(e===null||typeof e!="object"||Array.isArray(e)||e.type!=="page"||typeof e.url!="string"||typeof e.webSocketDebuggerUrl!="string")return!1;try{return re(e.webSocketDebuggerUrl),!0}catch{return!1}}function qe(e){return new Promise(n=>setTimeout(n,e))}async function G(e,n){const t=Math.max(0,n.deadline-Date.now());let o=null;try{return await Promise.race([e,new Promise((r,a)=>{o=setTimeout(()=>{var s;(s=n.onTimeout)==null||s.call(n),a(new Error(`${n.label} timed out after ${n.timeoutMs}ms`))},t)})])}finally{o&&clearTimeout(o)}}async function q(e,n,t={}){const o=P(t.timeoutMs??We,"timeoutMs",{allowZero:!1}),r=t.fetchImpl??globalThis.fetch;if(typeof r!="function")throw new TypeError("fetchImpl must be a function");const a=`http://127.0.0.1:${e}/json/list`,s=new AbortController,c=Date.now()+o,i=t.quiet===!0;i||console.log(`[cdp] fetchRendererTargets: port=${e}, timeoutMs=${o}, endpoint=${a}`);let m;try{m=await G(Promise.resolve(r(a,{redirect:"error",signal:s.signal})),{deadline:c,timeoutMs:o,label:"renderer target discovery",onTimeout:()=>s.abort()})}catch(u){throw i||console.log("[cdp] fetchRendererTargets error:",u),new Error(`failed to fetch renderer targets from ${a}: ${u.message}`)}if(m===null||typeof m!="object"||!m.ok)throw new Error(`renderer target discovery failed with HTTP ${(m==null?void 0:m.status)??"unknown"}`);let h;try{h=await G(Promise.resolve(m.json()),{deadline:c,timeoutMs:o,label:"renderer target discovery JSON",onTimeout:()=>s.abort()})}catch(u){throw new Error(`malformed renderer target JSON from ${a}: ${u.message}`)}if(!Array.isArray(h))throw new Error("malformed renderer target JSON: expected an array");return h.filter(u=>Fe(u,n)).sort(ze)}async function He(e,n,t={}){const o=P(t.timeoutMs??Ne,"timeoutMs",{allowZero:!0}),r=P(t.pollMs??Oe,"pollMs",{allowZero:!1}),a=t.fetchImpl??globalThis.fetch;let s=0;const c=Date.now()+o;let i=new Error("no renderer discovery attempt completed");for(console.log(`[cdp] waitForRendererTargets: port=${e}, hint=${n}, timeoutMs=${o}`);;){try{const h=Math.max(1,Math.min(o-s,c-Date.now()));console.log(`[cdp] Attempting fetch: elapsed=${s}ms, remainingBudget=${h}ms, deadline=${c}`);const u=await q(e,n,{fetchImpl:a,timeoutMs:h});if(u.length>0)return u;i=new Error("no matching renderer/index.html page targets")}catch(h){i=h instanceof Error?h:new Error(String(h)),console.log("[cdp] Fetch error:",i.message)}if(s>=o||Date.now()>=c)throw new Error(`timed out after ${o}ms waiting for renderer targets on 127.0.0.1:${e}: ${i.message}`);const m=Math.min(r,o-s);await qe(m),s+=m}}class H{constructor(n,t={}){k(this,"webSocketDebuggerUrl");k(this,"WebSocketImpl");k(this,"commandTimeoutMs");k(this,"connectTimeoutMs");k(this,"socket",null);k(this,"nextRequestId",1);k(this,"pending",new Map);k(this,"socketOpen",!1);k(this,"opened",!1);k(this,"closed",!1);k(this,"closeStarted",!1);k(this,"terminalError",null);k(this,"openPromise",null);k(this,"resolveOpen",null);k(this,"rejectOpen",null);k(this,"connectTimer",null);this.webSocketDebuggerUrl=n;let o=null,r=null;try{o=require("ws")??null,o||(r="ws loaded but WebSocket is undefined")}catch(a){r=`ws require failed: ${(a==null?void 0:a.message)??a}`}if(!o)try{const a=require("undici");o=(a==null?void 0:a.WebSocket)??null,o||(r="undici loaded but WebSocket is undefined")}catch(a){r=`undici require failed: ${(a==null?void 0:a.message)??a}`}if(!o&&typeof globalThis.WebSocket=="function"&&(o=globalThis.WebSocket,r=null),!o){const a=r?` (${r})`:"";throw new Error(`No WebSocket implementation available for CDP${a}`)}this.WebSocketImpl=t.WebSocketImpl??o,this.commandTimeoutMs=P(t.commandTimeoutMs??Be,"commandTimeoutMs"),this.connectTimeoutMs=P(t.connectTimeoutMs??Ue,"connectTimeoutMs")}open(){if(this.closed)return Promise.reject(this.terminalError??new Error("CDP session is closed"));if(this.opened)return Promise.resolve(this);if(this.openPromise)return this.openPromise;this.openPromise=new Promise((t,o)=>{this.resolveOpen=t,this.rejectOpen=o}),this.connectTimer=setTimeout(()=>{this.terminate(new Error(`CDP WebSocket connect timed out after ${this.connectTimeoutMs}ms`)),this.closeSocket()},this.connectTimeoutMs);try{this.socket=new this.WebSocketImpl(this.webSocketDebuggerUrl)}catch(t){return this.terminate(new Error(`failed to open CDP WebSocket: ${t.message}`)),this.openPromise}const n=this.socket;return n.onopen=()=>{this.closed||this.socketOpen||(this.clearConnectTimer(),this.socketOpen=!0,Promise.all([this.send("Runtime.enable"),this.send("Page.enable")]).then(()=>{if(this.closed)return;this.opened=!0;const t=this.resolveOpen;this.resolveOpen=null,this.rejectOpen=null,t==null||t(this)}).catch(t=>{this.terminate(t),this.closeSocket()}))},n.onmessage=t=>this.handleMessage(t),n.onerror=t=>{const o=t.error,r=o instanceof Error?o.message:typeof t.message=="string"&&t.message.length>0?t.message:"unknown socket error";this.terminate(new Error(`CDP WebSocket error: ${r}`)),this.closeSocket()},n.onclose=()=>{this.closeStarted=!0,this.terminate(new Error("CDP WebSocket closed"))},this.openPromise}send(n,t={},o={}){if(this.closed)return Promise.reject(this.terminalError??new Error("CDP session is closed"));if(!this.socketOpen||!this.socket)return Promise.reject(new Error("CDP session is not open"));if(typeof n!="string"||n.length===0)return Promise.reject(new TypeError("CDP method must be a non-empty string"));const r=P(o.timeoutMs??this.commandTimeoutMs,"timeoutMs"),a=this.nextRequestId++;return new Promise((s,c)=>{const i=setTimeout(()=>{this.pending.delete(a),c(new Error(`CDP ${n} timed out after ${r}ms`))},r);this.pending.set(a,{resolve:s,reject:c,timer:i});try{this.socket.send(JSON.stringify({id:a,method:n,params:t}))}catch(m){clearTimeout(i),this.pending.delete(a),c(new Error(`failed to send CDP ${n}: ${m.message}`))}})}async evaluate(n,t={}){var r,a,s;if(typeof n!="string")throw new TypeError("Runtime.evaluate expression must be a string");const o=await this.send("Runtime.evaluate",{expression:n,awaitPromise:!0,returnByValue:!0},t);if(o!=null&&o.exceptionDetails)throw new Error(`Runtime.evaluate failed: ${((r=o.exceptionDetails.exception)==null?void 0:r.description)??o.exceptionDetails.text??"unknown JavaScript exception"}`);if(((a=o==null?void 0:o.result)==null?void 0:a.type)!=="undefined")return(s=o==null?void 0:o.result)==null?void 0:s.value}close(){this.closeStarted||(this.terminate(new Error("CDP session closed by client")),this.closeSocket())}handleMessage(n){if(typeof n.data!="string"){this.terminate(new Error("received a non-text CDP WebSocket message")),this.closeSocket();return}let t;try{t=JSON.parse(n.data)}catch(r){this.terminate(new Error(`received malformed CDP JSON: ${r.message}`)),this.closeSocket();return}if(!Number.isInteger(t==null?void 0:t.id))return;const o=this.pending.get(t.id);if(o){if(this.pending.delete(t.id),clearTimeout(o.timer),t.error){o.reject(new Error(`CDP error: ${t.error.message}`));return}o.resolve(t.result)}}terminate(n){if(this.terminalError)return;this.clearConnectTimer(),this.terminalError=n,this.closed=!0,this.socketOpen=!1;const t=this.rejectOpen;this.resolveOpen=null,this.rejectOpen=null,t==null||t(n);for(const{reject:o,timer:r}of this.pending.values())clearTimeout(r),o(n);this.pending.clear()}clearConnectTimer(){this.connectTimer!==null&&(clearTimeout(this.connectTimer),this.connectTimer=null)}closeSocket(){if(this.closeStarted||(this.closeStarted=!0,!this.socket||typeof this.socket.close!="function"))return;const n=this.WebSocketImpl.CLOSING??2,t=this.WebSocketImpl.CLOSED??3;this.socket.readyState===n||this.socket.readyState===t||this.socket.close()}}function ze(e,n){const t=[String(e.id??""),e.url,e.webSocketDebuggerUrl],o=[String(n.id??""),n.url,n.webSocketDebuggerUrl];for(let r=0;r<t.length;r++){if(t[r]<o[r])return-1;if(t[r]>o[r])return 1}return 0}function Je(){return l.join(w.app.getAppPath(),"themes")}function ae(){const e=l.join(w.app.getPath("userData"),"themes");return d.mkdirSync(e,{recursive:!0}),e}function Ke(){return[ae(),Je()]}const Q=new Map;function O(e){var r;const n=[],t=new Set;for(const a of Ke()){if(!d.existsSync(a))continue;const s=d.readdirSync(a,{withFileTypes:!0});for(const c of s){if(!c.isDirectory())continue;const i=l.join(a,c.name),m=l.join(i,"theme.json");if(d.existsSync(m))try{const h=JSON.parse(d.readFileSync(m,"utf-8")),u=Ye(h);if(t.has(u.id))continue;const f=l.join(i,u.hero);if(!d.existsSync(f)||!d.statSync(f).isFile())throw new Error(`theme hero is missing: ${u.hero}`);if(e&&((r=u.apps[e])==null?void 0:r.compat)!==!0)continue;t.add(u.id),n.push({id:u.id,name:u.name,author:u.author,path:i,manifest:u})}catch(h){console.error(`Failed to load theme ${c.name}:`,h)}}}const o=new Map;for(const a of n){const s=l.join(a.path,a.manifest.hero),c=R(s),i=`${a.name.trim().toLocaleLowerCase()}\0${a.author.trim().toLocaleLowerCase()}\0${c}`,m=o.get(i);(!m||Ve(a.id,m.id))&&o.set(i,a)}return[...o.values()].sort((a,s)=>a.name.localeCompare(s.name))}function R(e){const n=d.statSync(e),t=Q.get(e);if(t&&t.size===n.size&&t.mtimeMs===n.mtimeMs)return t.hash;const o=te.createHash("sha256").update(d.readFileSync(e)).digest("hex");return Q.set(e,{size:n.size,mtimeMs:n.mtimeMs,hash:o}),o}function Ve(e,n){const t=e.startsWith("custom-"),o=n.startsWith("custom-");return t!==o?!t:e.length<n.length||e.length===n.length&&e.localeCompare(n)<0}function se(e,n){return O(n).find(t=>t.id===e)}function Ge(e){const n=se(e);if(!n)return;const t=l.resolve(n.path,n.manifest.hero);if(t.startsWith(`${l.resolve(n.path)}${l.sep}`))return t}function Qe(e){return`theme-asset://local/${encodeURIComponent(e)}`}function Ze(e){const n=l.join(e.path,e.manifest.hero),t=d.readFileSync(n);return`data:${et(e.manifest.hero)};base64,${t.toString("base64")}`}function Xe(e,n,t){const o=R(t);return O().some(r=>r.name.trim().toLowerCase()!==e.trim().toLowerCase()||r.author.trim().toLowerCase()!==n.trim().toLowerCase()?!1:R(l.join(r.path,r.manifest.hero))===o)}function Ye(e){if(typeof e!="object"||e===null||Array.isArray(e))throw new Error("theme manifest must be an object");if(e.schemaVersion!==1)throw new Error(`unsupported theme schema ${e.schemaVersion}`);if(typeof e.id!="string"||!/^[a-z0-9-]+$/.test(e.id))throw new Error("theme id must use lowercase letters, numbers, and hyphens");if(typeof e.name!="string"||!e.name.trim())throw new Error("theme name must be a non-empty string");if(typeof e.author!="string")throw new Error("theme author must be a string");if(typeof e.hero!="string")throw new Error("theme hero must be a string");if(typeof e.colors!="object"||e.colors===null)throw new Error("theme colors must be an object");const n=["accent","secondary","surface","text"];for(const t of n)if(typeof e.colors[t]!="string"||!/^#[0-9a-fA-F]{6}$/.test(e.colors[t]))throw new Error(`theme color ${t} must be a hex color`);return{schemaVersion:1,id:e.id,name:e.name.trim(),author:e.author,hero:e.hero,colors:{accent:e.colors.accent,secondary:e.colors.secondary,surface:e.colors.surface,text:e.colors.text},copy:e.copy??void 0,apps:e.apps??{}}}function et(e){const n=l.extname(e).toLowerCase();return{".png":"image/png",".jpg":"image/jpeg",".jpeg":"image/jpeg",".webp":"image/webp",".gif":"image/gif"}[n]||"image/png"}const _="dream-work-style",E="dream-work-menu",y={id:"wb-dream-sentinel-id",hero:"data:image/png;base64,WBDREAMHEROSENTINEL",accent:"#010203",secondary:"#040506",surface:"#070809",text:"#0a0b0c"};let D=null;async function tt(){if(!D)try{const e=l.resolve(__dirname,"manager","codex-dream-skin.css");D=await ye.readFile(e,"utf-8")}catch(e){console.warn("[injector] Failed to load Codex base CSS:",e.message),D=""}return D}async function ie(e,n,t,o={}){const r=$(e),a=o.rendererUrlHint?[o.rendererUrlHint]:(r==null?void 0:r.rendererHints)??["renderer/index.html","index.html"];let s=[],c="No renderer targets found";for(const i of a)try{if(console.log(`[injector] Trying hint "${i}" on port ${t}`),s=await He(t,i,{timeoutMs:2e4,pollMs:500}),s.length>0){console.log(`[injector] Found ${s.length} targets with hint "${i}"`);break}}catch(m){c=m.message,console.log(`[injector] Hint "${i}" failed: ${m.message}`)}if(s.length===0)try{console.log(`[injector] Strict hints failed, trying relaxed page-target fallback on port ${t}`);const m=await(await fetch(`http://127.0.0.1:${t}/json/list`,{signal:AbortSignal.timeout(5e3)})).json(),h=(Array.isArray(m)?m:[]).filter(F).sort((u,f)=>{const x=[String(u.id??""),u.url,u.webSocketDebuggerUrl],g=[String(f.id??""),f.url,f.webSocketDebuggerUrl];for(let p=0;p<x.length;p++){if(x[p]<g[p])return-1;if(x[p]>g[p])return 1}return 0});h.length>0&&(console.log(`[injector] Relaxed fallback found ${h.length} page targets`),s=h)}catch(i){console.log(`[injector] Relaxed fallback failed: ${i.message}`)}if(s.length===0)return{success:!1,applied:0,error:c};try{const i=O(e);if(console.log(`[injector] Loaded ${i.length} themes`),!i.some(p=>p.id===n))return{success:!1,applied:0,error:`Theme ${n} is not compatible with ${e}`};const m=new Set(["lisa","mbappe","nagasawa-masami","ronaldo",n]),h=i.filter(p=>m.has(p.id)),u=new Map;for(const p of h)u.set(p.id,{name:p.name,css:Z(e,p.manifest,Ze(p)),surface:p.manifest.colors.surface});const f=Array.from(u.entries()).map(([p,b])=>{var A;return{id:p,name:b.name,css:b.css,surface:b.surface,accent:((A=i.find(v=>v.id===p))==null?void 0:A.manifest.colors.accent)??"#24c9d7"}}),x=e==="workbuddy"?dt({styleId:_,menuId:E,currentThemeId:n,themes:f,cssTemplate:ce({id:y.id,colors:{accent:y.accent,secondary:y.secondary,surface:y.surface,text:y.text},copy:null},y.hero,{accent:y.accent,secondary:y.secondary,surface:y.surface,text:y.text})}):mt({styleId:_,menuId:E,currentThemeId:n,appId:e,themes:f,cssTemplate:Z(e,{id:y.id,colors:{accent:y.accent,secondary:y.secondary,surface:y.surface,text:y.text}},y.hero)});let g=0;for(const p of s)try{console.log(`[injector] Injecting to target ${p.id}: ${p.url}`);const b=new H(p.webSocketDebuggerUrl);if(await b.open(),e==="workbuddy"&&!await b.evaluate(`(() => {
          ...
          })()`)){console.warn(`[injector] Skipping non-WorkBuddy target ${p.id}: ${p.url}`),b.close();continue}if(e==="codex"){const v=await tt();v&&await b.evaluate(`(() => {
              const existing = document.getElementById('codex-dream-skin-base');
              if (!existing) {
                const style = document.createElement('style');
                style.id = 'codex-dream-skin-base';
                style.textContent = ${JSON.stringify(v)};
                document.head.appendChild(style);
              }
            })()`)}const A=await b.evaluate(x);if(console.log(`[injector] Injection result for target ${p.id}:`,A),e==="codex")for(let v=1;v<=4;v++){const B=await b.evaluate(`(() => {
            ...
            })`);if(B.homeClasses&&B.homeClasses.includes("dream-skin-home")){console.log(`[injector] Codex home detection for ${p.id}: attempt=${v}`,JSON.stringify(B));break}v<4&&await new Promise(ue=>setTimeout(ue,800))}if(e==="codex")try{const v=await b.evaluate(`(() => {
            ...
            })()`);console.log(`[injector] Codex debug info for ${p.id}:`,JSON.stringify(v,null,2))}catch(v){console.error(`[injector] Failed to get debug info for ${p.id}:`,v)}b.close(),g++}catch(b){console.error(`[injector] Failed to inject to target ${p.id}:`,b)}return{success:g>0,applied:g}}catch(i){return console.error("[injector] Injection failed:",i),{success:!1,applied:0,error:i.message}}}async function nt(e,n,t={}){var c;const o=t.rendererUrlHint?[t.rendererUrlHint]:((c=$(e))==null?void 0:c.rendererHints)??["renderer/index.html","index.html"];let r=[];for(const i of o)try{if(r=await q(n,i,{timeoutMs:1e3,quiet:!0}),r.length>0)break}catch{}if(r.length===0)try{const m=await(await fetch(`http://127.0.0.1:${n}/json/list`,{signal:AbortSignal.timeout(5e3)})).json();r=(Array.isArray(m)?m:[]).filter(F).sort((h,u)=>{const f=[String(h.id??""),h.url,h.webSocketDebuggerUrl],x=[String(u.id??""),u.url,u.webSocketDebuggerUrl];for(let g=0;g<f.length;g++){if(f[g]<x[g])return-1;if(f[g]>x[g])return 1}return 0})}catch{}if(r.length===0)return{installed:!1,menu:!1,targets:0};const a=[];for(const i of r){const m=new H(i.webSocketDebuggerUrl);try{if(await m.open(),e==="workbuddy"&&!await m.evaluate("(() => document.body?.dataset.applicationName === 'workbuddy')()"))continue;a.push(await m.evaluate(`(() => {
      ...
      })`))}catch{}finally{m.close()}}const s=a.find(i=>i.installed&&i.themeId)??a.find(i=>i.installed);return{installed:a.some(i=>i.installed),menu:a.some(i=>i.menu),themeId:s==null?void 0:s.themeId,targets:a.length}}async function ot(e,n,t={}){var c;const o=t.rendererUrlHint??((c=$(e))==null?void 0:c.rendererHints[0])??"renderer/index.html";let r=[];try{r=await q(n,o)}catch{}if(r.length===0)try{const m=await(await fetch(`http://127.0.0.1:${n}/json/list`,{signal:AbortSignal.timeout(5e3)})).json();r=(Array.isArray(m)?m:[]).filter(F).sort((h,u)=>{const f=[String(h.id??""),h.url,h.webSocketDebuggerUrl],x=[String(u.id??""),u.url,u.webSocketDebuggerUrl];for(let g=0;g<f.length;g++){if(f[g]<x[g])return-1;if(f[g]>x[g])return 1}return 0})}catch{}if(r.length===0)return{success:!1};const a=r[0],s=new H(a.webSocketDebuggerUrl);return await s.open(),await s.evaluate(`(() => {
    ...
    return true;
  })`),s.close(),{success:!0}}function Z(e,n,t){var a,s,c,i;const o={accent:((a=n.colors)==null?void 0:a.accent)??"#24c9d7",secondary:((s=n.colors)==null?void 0:s.secondary)??"#ef8fd3",surface:((c=n.colors)==null?void 0:c.surface)??"#f7fbff",text:((i=n.colors)==null?void 0:i.text)??"#17344f"};if(e==="codex")return ct(n,t,o);const r=$(e);return(r==null?void 0:r.kind)==="vscode-work"?rt(n,t,o):(r==null?void 0:r.kind)==="generic-work"?at(e,n,t,o):ce({...n,copy:null},t,o)}function rt(e,n,t){return`/* DREAM_THEME:${e.id} */
:root {
...
`}function X(e,n=""){return JSON.stringify(typeof e=="string"?e:n)}function ce(e,n,t){var r,a;return`/* DREAM_THEME:${String(e.id??"custom").replace(/[^a-z0-9_-]/gi,"")} */
...
#root::before {
  ...
  top: 60px;
  left: max(300px, 22vw);
  content: ${X((r=e.copy)==null?void 0:r.brand)};
  color: var(--wb-accent);
...
#root::after {
  ...
  left: max(300px, 22vw);
  max-width: 42vw;
  content: ${X((a=e.copy)==null?void 0:a.headline)};
  color: var(--wb-text);
  font: 750 clamp(18px, 2.7vw, 42px)/1.15 ui-rounded, system-ui;
  text-shadow: 0 2px 12px white;
  pointer-events: none;
}`}function ct(e,n,t){const o=lt(t.surface),r=o?`color-mix(in srgb, ${t.surface} 90%, transparent)`:`color-mix(in srgb, ${t.surface} 86%, transparent)`,a=o?`color-mix(in srgb, ${t.accent} 16%, ${t.surface})`:`color-mix(in srgb, ${t.accent} 42%, ${t.surface})`,s=o?"#172033":`color-mix(in srgb, ${t.surface} 72%, #000000)`,c="#f2f6ff",i=`/* DREAM_THEME:${e.id} */
...
`+m}function lt(e){const n=/^#([0-9a-f]{6})$/i.exec(e);if(!n)return!0;const t=parseInt(n[1],16);return .299*(t>>16&255)+.587*(t>>8&255)+.114*(t&255)>140}function dt(e){return`(() => {
  const data = ${JSON.stringify({styleId:e.styleId,menuId:e.menuId,activeId:e.currentThemeId,themes:e.themes,cssTemplate:e.cssTemplate,sentinels:y,storageKey:"dreamCustomThemes",selectedKey:"wb-dream-selected"})};
  ...
  return true;
})()`}function mt(e){const n=JSON.stringify(e.themes),t=JSON.stringify(e.cssTemplate??""),o=e.appId;return`(() => {
  const themes = ${n};
  const cssTemplate = ${t};
  const sentinels = ${JSON.stringify(y)};
  ...
  applyTheme(currentThemeId);
})()`}async function ut(e){try{return C.platform()==="win32"?pt(e):C.platform()==="darwin"?ht(e):C.platform()==="linux"?gt(e):{success:!1,error:`Unsupported platform: ${C.platform()}`}}catch(n){return{success:!1,error:n.message}}}function pt(e){const n=l.join(C.homedir(),"Desktop"),t=l.join(n,`${e.label}.lnk`),o=process.execPath,r=l.dirname(o),a=`
    ...
    $Shortcut.Save()
  `;return new Promise(s=>{require("child_process").exec(`powershell -Command "${a.replace(/"/g,'\\"')}"`,c=>{s(c?{success:!1,error:c.message}:{success:!0,path:t})})})}function ht(e){const n=l.join(C.homedir(),"Desktop"),t=l.join(n,`${e.label}.app`),r=`
    tell application "Terminal"
      do script "'${process.execPath}' --launch=${e.appId}:${e.themeId}"
    end tell
  `,a=l.join(n,`${e.id}.scpt`);return d.writeFileSync(a,r),new Promise(s=>{require("child_process").exec(`osacompile -o "${t}" "${a}"`,c=>{d.unlinkSync(a),s(c?{success:!1,error:c.message}:{success:!0,path:t})})})}async function gt(e){const n=l.join(C.homedir(),".local","share","applications");d.existsSync(n)||d.mkdirSync(n,{recursive:!0});const t=l.join(n,`${e.id}.desktop`),o=process.execPath,r=`[Desktop Entry]
Type=Application
Name=${e.label}
...
Terminal=false
Categories=Utility;
`;return d.writeFileSync(t,r),d.chmodSync(t,493),{success:!0,path:t}}const ft=N.promisify(j.execFile),bt="https://api.dreamskin.cc",le=`${bt}/v1/themes`,de=32*1024*1024,L=6;let U=0;const wt=["workbuddy","codex","trae-work","qoder-work","catpaw","zcode","qwen-office"];async function xt(){const e=U,n=await yt(e),t=n.items;U=e+t.length>=n.total?0:e+L;const o=ae(),r={checked:t.length,imported:0,skipped:0,offset:e,page:Math.floor(e/L)+1,total:n.total,nextOffset:U,failed:[]};for(const a of t){const s=$t(a.themeId);if(!a.applyCompatible||se(s)){r.skipped++;continue}try{await kt(a,o,s)?r.imported++:r.skipped++}catch(c){r.failed.push({id:a.id,name:a.name,error:c.message})}}return r}async function yt(e){const n=`${le}?limit=${L}&offset=${e}&sort=recent`,t=await fetch(n,{signal:AbortSignal.timeout(3e4),redirect:"error"});if(!t.ok)throw new Error(`Theme list request failed: HTTP ${t.status}`);const o=await t.json();if(!Array.isArray(o.items)||o.items.length>L||!Number.isInteger(o.total)||o.total<0)throw new Error("Theme list response is invalid");return{items:o.items,total:o.total}}async function kt(e,n,t){St(e);const o=d.mkdtempSync(l.join(C.tmpdir(),"dream-work-theme-")),r=l.join(o,"theme.zip"),a=l.join(o,"extract"),s=l.join(n,`.updating-${t}-${process.pid}`);try{d.mkdirSync(a);const c=`${le}/${e.id}/download`,i=await fetch(c,{signal:AbortSignal.timeout(12e4),redirect:"error"});if(!i.ok)throw new Error(`Theme download failed: HTTP ${i.status}`);const m=Buffer.from(await i.arrayBuffer());if(m.length!==e.packageBytes)throw new Error(`Downloaded size mismatch: expected ${e.packageBytes}, got ${m.length}`);if(m.length>de)throw new Error("Theme package exceeds 32 MiB");if(te.createHash("sha256").update(m).digest("hex")!==e.packageSha256)throw new Error("Downloaded SHA-256 does not match metadata");d.writeFileSync(r,m,{flag:"wx"}),await vt(r,a);const u=Ct(a),f=JSON.parse(d.readFileSync(l.join(u,"theme.json"),"utf8")),x=f.image;if(typeof x!="string"||l.basename(x)!==x||!/\.(png|jpe?g|webp)$/i.test(x))throw new Error("Theme image name is invalid");const g=l.join(u,x),p=l.join(u,"theme.css");if(!d.existsSync(g)||!d.statSync(g).isFile())throw new Error("Theme image is missing");if(!d.existsSync(p)||!d.statSync(p).isFile())throw new Error("theme.css is missing");const b=Tt(f,e,t,`hero${l.extname(x).toLowerCase()}`);return Xe(b.name,b.author,g)?!1:(d.mkdirSync(s),d.copyFileSync(g,l.join(s,b.hero)),d.copyFileSync(p,l.join(s,"theme.css")),d.writeFileSync(l.join(s,"theme.json"),`${JSON.stringify(b,null,2)}
`),d.renameSync(s,l.join(n,t)),!0)}finally{d.rmSync(s,{recursive:!0,force:!0}),d.rmSync(o,{recursive:!0,force:!0})}}async function vt(e,n){const{path7za:t}=require("7zip-bin");await ft(t,["x",e,`-o${n}`,"-y"],{windowsHide:!0,timeout:12e4})}function Ct(e){const t=[e,...d.readdirSync(e,{withFileTypes:!0}).filter(o=>o.isDirectory()).map(o=>l.join(e,o.name))].filter(o=>d.existsSync(l.join(o,"theme.json"))&&d.existsSync(l.join(o,"theme.css")));if(t.length!==1)throw new Error("Theme ZIP must contain one theme root");return t[0]}function St(e){if(!/^ver_[a-z0-9]{8,64}$/.test(e.id))throw new Error("Theme version ID is invalid");if(!Number.isInteger(e.packageBytes)||e.packageBytes<1||e.packageBytes>de)throw new Error("Theme package size is invalid");if(!/^[a-f0-9]{64}$/.test(e.packageSha256))throw new Error("Theme package SHA-256 is invalid")}function $t(e){return String(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").replace(/-+/g,"-")||"community-theme"}function Tt(e,n,t,o){const r=e.appearance==="dark"?"dark":"light",a=r==="dark"?"#10141c":"#f4f7fa",s=e.colors||{};return{schemaVersion:1,id:t,name:String(e.name||n.name||t).trim(),author:n.authorDisplayName||"DreamSkin Community",hero:o,colors:{accent:M(s.accent,"#4f8cff",a),secondary:M(s.secondary||s.accentAlt,"#7ba7d8",a),surface:M(s.panelAlt||s.panel||s.background,a,a),text:M(s.text,r==="dark"?"#eef2f7":"#1f2937",a)},copy:null,apps:Object.fromEntries(wt.map(c=>[c,{compat:!0}]))}}function M(e,n,t){if(typeof e!="string")return n;const o=e.trim().match(/^#([0-9a-f]{3}|[0-9a-f]{6}|[0-9a-f]{8})$/i);if(o){let i=o[1];return i.length===3&&(i=i.split("").map(m=>m+m).join("")),`#${i.slice(0,6).toLowerCase()}`}const r=e.trim().match(/^rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})(?:\s*,\s*(0|1|0?\.\d+))?\s*\)$/i);if(!r)return n;const a=r[4]===void 0?1:Number(r[4]),s=M(t,n,n).slice(1).match(/../g).map(i=>parseInt(i,16));return`#${[1,2,3].map(i=>Math.round(Number(r[i])*a+s[i-1]*(1-a))).map(i=>i.toString(16).padStart(2,"0")).join("")}`}let W=null;w.protocol.registerSchemesAsPrivileged([{scheme:"theme-asset",privileges:{standard:!0,secure:!0,supportFetchAPI:!0,stream:!0}}]);function me(){W=new w.BrowserWindow({width:1200,height:800,webPreferences:{preload:l.join(__dirname,"preload.js"),contextIsolation:!0,nodeIntegration:!1}}),process.env.VITE_DEV_SERVER_URL?W.loadURL(process.env.VITE_DEV_SERVER_URL):W.loadFile(l.join(__dirname,"../renderer/dist/index.html"))}w.app.whenReady().then(()=>{w.protocol.handle("theme-asset",e=>{const n=decodeURIComponent(new URL(e.url).pathname.replace(/^\//,"")),t=Ge(n);return t?new Response(d.readFileSync(t),{headers:{"Content-Type":Et(t),"Cache-Control":"public, max-age=3600"}}):new Response("Theme asset not found",{status:404})}),me()});function Et(e){const n=l.extname(e).toLowerCase();return n===".jpg"||n===".jpeg"?"image/jpeg":n===".webp"?"image/webp":"image/png"}w.app.on("window-all-closed",()=>{process.platform!=="darwin"&&w.app.quit()});w.app.on("activate",()=>{w.BrowserWindow.getAllWindows().length===0&&me()});const Y=process.argv.find(e=>e.startsWith("--launch="));if(Y){const[,e]=Y.split("="),[n,t]=e.split(":");n&&t&&(console.log(`[main] Received launch args: ${n}:${t}`),setTimeout(async()=>{try{const o=await oe(n,t);o.success?(console.log(`[main] Launched ${n} with theme ${t} on port ${o.port}`),setTimeout(async()=>{try{console.log(`[main] Starting theme injection for ${n}:${t} on port ${o.port}`);const r=await ie(n,t,o.port);console.log("[main] Injection result:",r)}catch(r){console.error("[main] Failed to inject theme:",r)}},3e3)):console.error(`[main] Failed to launch ${n}: ${o.error}`)}catch(o){console.error("[main] Launch error:",o)}},1e3))}w.ipcMain.handle("discover-apps",async()=>Te());w.ipcMain.handle("launch-app",async(e,n,t)=>oe(n,t));w.ipcMain.handle("apply-theme",async(e,n,t,o)=>ie(n,t,o));w.ipcMain.handle("create-shortcut",async(e,n)=>{const t={...n,id:`${n.appId}-${n.themeId}-${Date.now()}`};return ut(t)});w.ipcMain.handle("list-themes",async(e,n)=>O(n).map(t=>({id:t.id,name:t.name,author:t.author,hero:Qe(t.id)})));w.ipcMain.handle("update-themes",async()=>xt());w.ipcMain.handle("get-status",async(e,n,t)=>{var r;return await Ee(n)?{...await nt(n,t||((r=$(n))==null?void 0:r.defaultPort)||9339),running:!0}:{installed:!1,menu:!1,targets:0,running:!1}});w.ipcMain.handle("remove-skin",async(e,n,t)=>ot(n,t));w.ipcMain.handle("debug-targets",async(e,n)=>{try{const o=await(await fetch(`http://127.0.0.1:${n}/json/list`,{signal:AbortSignal.timeout(5e3)})).json();return{success:!0,count:o.length,raw:o,targets:o.map(r=>({id:r.id,type:r.type,url:r.url,title:r.title,webSocketDebuggerUrl:r.webSocketDebuggerUrl}))}}catch(t){return{success:!1,error:t.message}}});
