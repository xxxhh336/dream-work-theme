"use strict";var pt=Object.defineProperty;var ht=(e,t,n)=>t in e?pt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var D=(e,t,n)=>ht(e,typeof t!="symbol"?t+"":t,n);const T=require("electron"),gt=require("path"),ft=require("fs"),ae=require("child_process"),Ee=require("util"),bt=require("os"),wt=require("original-fs"),kt=require("http"),xt=require("net"),yt=require("fs/promises"),vt=require("crypto");function H(e){const t=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(e){for(const n in e)if(n!=="default"){const a=Object.getOwnPropertyDescriptor(e,n);Object.defineProperty(t,n,a.get?a:{enumerable:!0,get:()=>e[n]})}}return t.default=e,Object.freeze(t)}const l=H(gt),h=H(ft),v=H(bt),R=H(wt),Ge=H(kt),Ae=H(xt),Ie=H(vt),S=process.env.LOCALAPPDATA||l.join(v.homedir(),"AppData","Local"),X=process.env.APPDATA||l.join(v.homedir(),"AppData","Roaming"),P=process.env.ProgramFiles||"C:\\Program Files",M=process.env["ProgramFiles(x86)"]||"C:\\Program Files (x86)",le=[{id:"workbuddy",name:"WorkBuddy",exeNames:["WorkBuddy.exe"],processName:"WorkBuddy.exe",defaultPort:9339,installPaths:[l.join(S,"workbuddy"),l.join(S,"Programs","workbuddy"),l.join(P,"WorkBuddy"),l.join(M,"WorkBuddy"),"D:\\Program Files\\WorkBuddy"],rendererHints:["app.asar/renderer/index.html","renderer/index.html","index.html"],kind:"workbuddy",acceptsGenericThemes:!0,darwin:{appBundles:["WorkBuddy.app"],executableNames:["WorkBuddy"]},linux:{executableNames:["workbuddy","WorkBuddy"],desktopFiles:["workbuddy.desktop"]}},{id:"codex",name:"Codex",exeNames:["ChatGPT.exe","Codex.exe"],processName:"ChatGPT.exe",defaultPort:9340,installPaths:[l.join(S,"Programs","Codex"),l.join(S,"Programs","OpenAI","Codex"),l.join(P,"Codex"),l.join(M,"Codex"),"D:\\Program Files\\Codex"],rendererHints:["index.html","renderer/index.html"],kind:"codex",acceptsGenericThemes:!0,darwin:{appBundles:["ChatGPT.app","Codex.app"],executableNames:["ChatGPT","Codex"]},linux:{executableNames:["codex","Codex"],desktopFiles:["codex.desktop"]}},{id:"trae-work",name:"TRAE Work",exeNames:["TRAE SOLO CN.exe","TRAE Work CN.exe"],processName:"TRAE SOLO CN.exe",defaultPort:9341,installPaths:["D:\\Program Files\\TRAE SOLO CN",l.join(S,"Programs","TRAE SOLO CN"),l.join(P,"TRAE SOLO CN")],rendererHints:["solo/solo-lite.html","solo-lite.html"],kind:"vscode-work",acceptsGenericThemes:!0,darwin:{appBundles:["TRAE SOLO CN.app","TRAE Work CN.app","TRAE.app"],executableNames:["TRAE SOLO CN","TRAE Work CN","TRAE"]},linux:{executableNames:["trae","trae-work","TRAE"],desktopFiles:["trae.desktop","trae-work.desktop"]}},{id:"qoder-work",name:"QoderWork",exeNames:["QoderWork CN.exe","QoderWork.exe"],processName:"QoderWork CN.exe",defaultPort:9342,installPaths:["D:\\Program Files\\QoderWork CN",l.join(S,"Programs","QoderWork CN"),l.join(P,"QoderWork CN")],rendererHints:["out/renderer/index.html","renderer/index.html"],kind:"generic-work",devToolsActivePort:l.join(X,"QoderWork CN","DevToolsActivePort"),acceptsGenericThemes:!0,darwin:{appBundles:["QoderWork CN.app","QoderWork.app"],executableNames:["QoderWork CN","QoderWork"]},linux:{executableNames:["qoder-work","qoderwork","QoderWork"],desktopFiles:["qoder-work.desktop","qoderwork.desktop"]}},{id:"catpaw",name:"CatPaw",exeNames:["CatPaw.exe"],processName:"CatPaw.exe",defaultPort:9343,installPaths:[l.join(S,"CatPaw"),l.join(S,"Programs","CatPaw"),l.join(P,"CatPaw")],rendererHints:["app.asar/dist/index.html","dist/index.html"],kind:"generic-work",acceptsGenericThemes:!0,darwin:{appBundles:["CatPaw.app"],executableNames:["CatPaw"]},linux:{executableNames:["catpaw","CatPaw"],desktopFiles:["catpaw.desktop"]}},{id:"zcode",name:"ZCode",exeNames:["ZCode.exe"],processName:"ZCode.exe",defaultPort:9344,installPaths:["D:\\Program Files\\ZCode",l.join(S,"Programs","ZCode"),l.join(P,"ZCode")],rendererHints:["out/renderer/index.html","renderer/index.html"],kind:"generic-work",acceptsGenericThemes:!0,darwin:{appBundles:["ZCode.app"],executableNames:["ZCode"]},linux:{executableNames:["zcode","ZCode"],desktopFiles:["zcode.desktop"]}},{id:"qwen-office",name:"千问办公",exeNames:["QwenWorkCN.exe"],processName:"QwenWorkCN.exe",defaultPort:9345,installPaths:["D:\\Program Files\\QwenWorkCN",l.join(S,"Programs","QwenWorkCN"),l.join(P,"QwenWorkCN")],rendererHints:["out/renderer/index.html","renderer/index.html"],kind:"generic-work",devToolsActivePort:l.join(X,"QwenWorkCN","DevToolsActivePort"),acceptsGenericThemes:!0,darwin:{appBundles:["QwenWorkCN.app","Qwen Work.app"],executableNames:["QwenWorkCN","Qwen Work"]},linux:{executableNames:["qwen-work","qwenwork","QwenWorkCN"],desktopFiles:["qwen-work.desktop","qwenwork.desktop"]}},{id:"hana-agent",name:"HanaAgent",exeNames:["HanaAgent.exe"],processName:"HanaAgent.exe",defaultPort:9346,installPaths:[l.join(S,"Programs","HanaAgent"),l.join(P,"HanaAgent"),l.join(M,"HanaAgent")],rendererHints:[".hanako/artifacts/renderer/","artifacts/renderer/","/index.html"],kind:"generic-work",acceptsGenericThemes:!0,darwin:{appBundles:["HanaAgent.app"],executableNames:["HanaAgent"]},linux:{executableNames:["hana-agent","HanaAgent"],desktopFiles:["hana-agent.desktop"]}},{id:"kimi",name:"Kimi Work",exeNames:["Kimi.exe"],processName:"Kimi.exe",defaultPort:9347,installPaths:["D:\\Program Files\\Kimi",l.join(S,"Programs","Kimi"),l.join(P,"Kimi"),l.join(M,"Kimi")],rendererHints:["kimi-agent.html","kimichat.html","https://www.kimi.com/"],kind:"generic-work",devToolsActivePort:l.join(X,"kimi-desktop","DevToolsActivePort"),acceptsGenericThemes:!0,darwin:{appBundles:["Kimi.app"],executableNames:["Kimi"]},linux:{executableNames:["kimi","Kimi"],desktopFiles:["kimi.desktop"]}},{id:"opencode",name:"OpenCode",exeNames:["OpenCode.exe"],processName:"OpenCode.exe",defaultPort:9348,installPaths:[l.join(S,"Programs","@opencode-aidesktop"),l.join(S,"Programs","OpenCode"),l.join(P,"OpenCode"),l.join(M,"OpenCode")],rendererHints:["oc://renderer/index.html"],kind:"generic-work",devToolsActivePort:l.join(X,"ai.opencode.desktop","DevToolsActivePort"),windowsPathScopedKill:!0,acceptsGenericThemes:!0,darwin:{appBundles:["OpenCode.app"],executableNames:["OpenCode"]},linux:{executableNames:["opencode-desktop","OpenCode"],desktopFiles:["opencode-desktop.desktop"]}},{id:"doubao",name:"豆包",exeNames:["Doubao.exe"],processName:"Doubao.exe",defaultPort:9349,installPaths:[l.join(S,"Doubao","Application","app"),l.join(S,"Doubao","Application"),l.join(P,"Doubao"),l.join(M,"Doubao")],rendererHints:["doubao://doubao-chat/chat"],kind:"generic-work",windowsPathScopedKill:!0,acceptsGenericThemes:!0,darwin:{appBundles:["Doubao.app"],executableNames:["Doubao"]},linux:{executableNames:["doubao","Doubao"],desktopFiles:["doubao.desktop"]}},{id:"agnes-code",name:"AgnesCode",exeNames:["AgnesCode.exe"],processName:"AgnesCode.exe",defaultPort:9350,installPaths:["D:\\Program Files\\AgnesCode",l.join(S,"Programs","AgnesCode"),l.join(P,"AgnesCode"),l.join(M,"AgnesCode")],rendererHints:["app.asar/.vite/renderer/main_window/index.html"],kind:"generic-work",windowsPathScopedKill:!0,acceptsGenericThemes:!0,darwin:{appBundles:["AgnesCode.app"],executableNames:["AgnesCode"]},linux:{executableNames:["agnes-code","agnescode","AgnesCode"],desktopFiles:["agnes-code.desktop","agnescode.desktop"]}},{id:"minimax-code",name:"MiniMax Code",exeNames:["MiniMax Code.exe"],processName:"MiniMax Code.exe",defaultPort:9351,installPaths:["D:\\Program Files\\MiniMax Code",l.join(S,"Programs","MiniMax Code"),l.join(P,"MiniMax Code"),l.join(M,"MiniMax Code")],rendererHints:["app://./archon"],kind:"generic-work",windowsPathScopedKill:!0,acceptsGenericThemes:!0,darwin:{appBundles:["MiniMax Code.app"],executableNames:["MiniMax Code"]},linux:{executableNames:["minimax-code","MiniMax Code"],desktopFiles:["minimax-code.desktop"]}},{id:"astronclaw",name:"AstronClaw",exeNames:["AstronClaw.exe"],processName:"AstronClaw.exe",defaultPort:9352,installPaths:["D:\\Program Files\\AstronClaw",l.join(S,"Programs","AstronClaw"),l.join(P,"AstronClaw"),l.join(M,"AstronClaw")],rendererHints:["app.asar/out/renderer/index.html","out/renderer/index.html"],kind:"generic-work",windowsPathScopedKill:!0,acceptsGenericThemes:!0,darwin:{appBundles:["AstronClaw.app"],executableNames:["AstronClaw"]},linux:{executableNames:["astronclaw","AstronClaw"],desktopFiles:["astronclaw.desktop"]}},{id:"sparkdesk",name:"SparkDesk",exeNames:["SparkDesk.exe"],processName:"SparkDesk.exe",defaultPort:9354,installPaths:["D:\\Program Files\\SparkDesk",l.join(S,"Programs","SparkDesk"),l.join(P,"SparkDesk"),l.join(M,"SparkDesk")],rendererHints:["out/renderer/index.html#desk","out/renderer/index.html"],kind:"generic-work",windowsPathScopedKill:!0,acceptsGenericThemes:!0,darwin:{appBundles:["SparkDesk.app"],executableNames:["SparkDesk"]},linux:{executableNames:["sparkdesk","SparkDesk"],desktopFiles:["sparkdesk.desktop"]}},{id:"stepfun",name:"StepFun",exeNames:["StepFun.exe"],processName:"StepFun.exe",defaultPort:9353,installPaths:["D:\\Program Files\\StepFun\\StepFun",l.join(S,"Programs","StepFun"),l.join(P,"StepFun"),l.join(M,"StepFun")],rendererHints:["app://chat-web/"],kind:"generic-work",devToolsActivePort:l.join(X,"stepfun-desktop","DevToolsActivePort"),windowsPathScopedKill:!0,acceptsGenericThemes:!0,darwin:{appBundles:["StepFun.app"],executableNames:["StepFun"]},linux:{executableNames:["stepfun","StepFun"],desktopFiles:["stepfun.desktop"]}},{id:"deepseek-harness",name:"DSH Desktop",exeNames:["DSH Desktop.exe","DeepSeek Harness.exe"],processName:"DSH Desktop.exe",defaultPort:9355,installPaths:["D:\\Program Files\\DSH Desktop","D:\\Program Files\\DeepSeek Harness",l.join(S,"Programs","DSH Desktop"),l.join(S,"Programs","DeepSeek Harness"),l.join(P,"DSH Desktop"),l.join(P,"DeepSeek Harness"),l.join(M,"DSH Desktop"),l.join(M,"DeepSeek Harness")],rendererHints:["dsh-desktop-platform="],kind:"generic-work",windowsPathScopedKill:!0,acceptsGenericThemes:!0,darwin:{appBundles:["DSH Desktop.app","DeepSeek Harness.app"],executableNames:["DSH Desktop","DeepSeek Harness"]},linux:{executableNames:["dsh-desktop","DSH Desktop","deepseek-harness","DeepSeek Harness"],desktopFiles:["dsh-desktop.desktop","deepseek-harness.desktop"]}}];function j(e){return le.find(t=>t.id===e)}const Pe=Ee.promisify(ae.execFile);function St(){const e=[],t=l.join(process.env.ProgramFiles||"C:\\Program Files","WindowsApps");if(!h.existsSync(t))return e;try{const n=h.readdirSync(t);for(const a of n)if(/^OpenAI\.Codex_\d+/i.test(a)){const r=l.join(t,a,"app","ChatGPT.exe");h.existsSync(r)&&e.push(r)}}catch{}return e}async function $t(){const e=`
...
`)}function se(e,t,n){let a=0;const r=[];e.on("data",o=>{if(a+=o.length,a>dn){t.writeHead(413).end("Payload too large"),e.destroy();return}r.push(o)}),e.on("end",()=>{if(!t.headersSent)try{n(JSON.parse(Buffer.concat(r).toString("utf8")))}catch(o){t.writeHead(400).end(o.message)}})}function Me(e){if(!Array.isArray(e))throw new Error("Custom themes must be an array");return e.slice(0,et).map((t,n)=>{var r;if(!t||typeof t!="object")throw new Error(`Invalid custom theme at index ${n}`);const a=t;if(typeof a.id!="string"||!/^custom-[a-z0-9-]+$/i.test(a.id))throw new Error(`Invalid custom theme id at index ${n}`);if(typeof a.name!="string"||!a.name.trim())throw new Error(`Invalid custom theme name at index ${n}`);if(typeof a.dataUrl!="string"||!/^data:image\/(?:png|jpeg|webp);base64,[A-Za-z0-9+/=]+$/.test(a.dataUrl))throw new Error(`Invalid custom theme image at index ${n}`);for(const o of["accent","secondary","surface","text"])if(typeof((r=a.colors)==null?void 0:r[o])!="string"||!/^#[0-9a-f]{6}$/i.test(a.colors[o]))throw new Error(`Invalid custom theme color ${o} at index ${n}`);return{id:a.id,name:a.name.trim(),dataUrl:a.dataUrl,colors:{accent:a.colors.accent,secondary:a.colors.secondary,surface:a.colors.surface,text:a.colors.text}}})}function U(e,t,n){e.writeHead(t,{"Content-Type":"application/json; charset=utf-8"}),e.end(JSON.stringify(n))}const N="dream-work-style",C="dream-work-menu",te=new Map,Q=new Map,W=new Map,me=new Map,xe=new Map,ie=new Map,_e=new Map,ue=new Map,K=new Map,pe=new Map,Z=new Map,Y=new Map,he=new Map,ee=new Map,O=new Map,F="dream-work-theme:kimi:restored",G="dream-work-theme:kimi:action-at",ot=new Set,k={id:"wb-dream-sentinel-id",hero:"data:image/png;base64,WBDREAMHEROSENTINEL",accent:"#010203",secondary:"#040506",surface:"#070809",text:"#0a0b0c"};let ce=null;async function pn(){if(!ce)try{const e=l.resolve(__dirname,"manager","codex-dream-skin.css");ce=await yt.readFile(e,"utf-8")}catch(e){console.warn("[injector] Failed to load Codex base CSS:",e.message),ce=""}return ce}async function st(e,t,n,a={}){const r=j(e),o=a.rendererUrlHint?[a.rendererUrlHint]:(r==null?void 0:r.rendererHints)??["renderer/index.html","index.html"];let s=[],d="No renderer targets found";for(const i of o)try{if(console.log(`[injector] Trying hint "${i}" on port ${n}`),s=await Qt(n,i,{timeoutMs:2e4,pollMs:500}),s.length>0){console.log(`[injector] Found ${s.length} targets with hint "${i}"`);break}}catch(c){d=c.message,console.log(`[injector] Hint "${i}" failed: ${c.message}`)}if(e==="sparkdesk")try{const i=await ne(n);i.length>0&&(s=i)}catch(i){console.log(`[injector] Failed to collect SparkDesk targets: ${i.message}`)}if(e==="stepfun")try{const i=await je(n);i.length>0&&(s=i)}catch(i){console.log(`[injector] Failed to collect all StepFun targets: ${i.message}`)}if(e==="kimi")try{const i=await Oe(n);i.length>0&&(s=i),await bn(s)}catch(i){console.log(`[injector] Failed to collect all Kimi targets: ${i.message}`)}if(s.length===0)try{console.log(`[injector] Strict hints failed, trying relaxed page-target fallback on port ${n}`);const c=await(await fetch(`http://127.0.0.1:${n}/json/list`,{signal:AbortSignal.timeout(5e3)})).json(),m=(Array.isArray(c)?c:[]).filter(De).sort((u,p)=>{const g=[String(u.id??""),u.url,u.webSocketDebuggerUrl],b=[String(p.id??""),p.url,p.webSocketDebuggerUrl];for(let y=0;y<g.length;y++){if(g[y]<b[y])return-1;if(g[y]>b[y])return 1}return 0});m.length>0&&(console.log(`[injector] Relaxed fallback found ${m.length} page targets`),s=m)}catch(i){console.log(`[injector] Relaxed fallback failed: ${i.message}`)}if(s.length===0)return{success:!1,applied:0,error:d};try{const i=fe(e);if(console.log(`[injector] Loaded ${i.length} themes`),!i.some(f=>f.id===t))return{success:!1,applied:0,error:`Theme ${t} is not compatible with ${e}`};const c=un(e,i.map(f=>f.id),t),m=new Map(i.map(f=>[f.id,f])),u=c.map(f=>m.get(f)).filter(Boolean),p=new Map;for(const f of u){const x=_n(e,f);p.set(f.id,{name:f.name,css:ze(e,f.manifest,on(f))+(x?Tn(f):""),surface:f.manifest.colors.surface})}const g=Array.from(p.entries()).map(([f,x])=>{var E;return{id:f,name:x.name,css:x.css,surface:x.surface,accent:((E=i.find(w=>w.id===f))==null?void 0:E.manifest.colors.accent)??"#24c9d7"}});let b=be();if(b.length===0){const f=e==="workbuddy"?"dreamCustomThemes":"dreamCodexCustomThemes";for(const x of s){const E=new A(x.webSocketDebuggerUrl);try{await E.open();const w=await E.evaluate(`(() => localStorage.getItem(${JSON.stringify(f)}) || '[]')()`),_=JSON.parse(w).filter($=>!ot.has($==null?void 0:$.id));if(Array.isArray(_)&&_.length>0){b=mn(_);break}}catch(w){console.warn(`[injector] Failed to import existing custom themes from ${e} target ${x.id}:`,w)}finally{E.close()}}}const y=await we();if(e==="stepfun"){const f=Date.now();await fetch(`${y.appStateEndpoint}/stepfun`,{method:"PUT",headers:{Authorization:`Bearer ${y.token}`,"Content-Type":"application/json"},body:JSON.stringify({themeId:t,actionAt:f})}).catch(()=>{});for(const x of s.filter(E=>String(E.url).startsWith("app://chat-web/"))){const E=new A(x.webSocketDebuggerUrl);try{await E.open(),await E.evaluate(`(() => {
            ...
            })()`).catch(()=>!1),!w);)await new Promise($=>setTimeout($,100));if(!w){console.warn(`[injector] Skipping non-WorkBuddy target ${f.id}: ${f.url}`),x.close();continue}}if(e==="codex"){const w=await pn();w&&await x.evaluate(`(() => {
            ...
            })()`).catch(()=>!1),!w);_++)await new Promise($=>setTimeout($,100));if(!w){console.warn(`[injector] HanaAgent injection did not become ready for target ${f.id}`),x.close();continue}}if(e==="codex")for(let w=1;w<=4;w++){const _=await x.evaluate(`(() => {
            ...
            })`);if(_.homeClasses&&_.homeClasses.includes("dream-skin-home")){console.log(`[injector] Codex home detection for ${f.id}: attempt=${w}`,JSON.stringify(_));break}w<4&&await new Promise($=>setTimeout($,800))}if(e==="codex")try{const w=await x.evaluate(`(() => {
